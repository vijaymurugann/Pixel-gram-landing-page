...
We didn't build another photo app. We built photobooks your mother-in-law will cry over. Create an art-store quality hardcover directly from your phone in just 15 minutes.          </p>
          ...
          <button 
            onClick={onCtaClick}
            className="group flex items-center gap-4 pl-6 pr-2 py-2 bg-seerakku-yellow hover:bg-pink-400 rounded-full transition-all duration-300 shadow-[0_0_40px_-10px_rgba(255,215,0,0.6)] hover:shadow-[0_0_60px_-10px_rgba(255,215,0,0.8)] border border-white/20"
          >
